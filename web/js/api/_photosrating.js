...
const photosratingAPI_auto = {

    /** Gets all entries from 'photosrating' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/photosrating`, requestOptions);
        return response.data;
    },
};

export { photosratingAPI_auto };